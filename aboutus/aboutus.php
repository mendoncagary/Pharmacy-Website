...
<div id="header">
	...
	<nav id="mainmenu">
	<ul id="menu">
	<li class="menuitem"><a class="link1" href="aboutus.php">About us</a></li>
	...
	<div id="usermenu">
	 ...
	 ?>
           ...
           <div id="background">
							...
							<div id="aboutcontent">
							<strong>MediCare</strong> is the online gateway to your favourite medical store.
							<br>
							<br>
							It started its service in March 2016 and currently has<strong> Cash on Delivery</strong> Services in more than 3500 pincodes spread across all the major cities and towns in India. We also accept payments online through  Debit Cards, Credit Cards and PayPal. 
<br><br>At MediCare you can order the products from our stores from the convenience of your home. To start shopping, simply search for the products you wish to buy, choose the quantity and place the order. All orders are filled within 6 hrs during the regular business hours and on the next day for evening or weekend orders.	
							</div>
        ...
        <div class="footer-info">
            <div class="info-container">
                ...
                <ul>
                    <li><a href="aboutus.php">About Medicare</a></li>
